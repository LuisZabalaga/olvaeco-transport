    ...
    return (
        <List disablePadding sx={{pb: 1}}>
            <SettingItem
                ...
                value={'sound'}
                isChecked={selectedSettings.indexOf('sound') !== -1} subheader={undefined}            />
            <SettingItem
            ...
            <SettingItem
                ...
                isChecked={selectedSettings.indexOf('show-active-status') !== -1} subheader={undefined}            />
            <Divider component={"li"} sx={{my: 1.5}}/>
            <SettingItem
                icon={<ChatBubbleOutlineOutlinedIcon />}
                title={"Message requests"} subheader={undefined} onChangeCallback={undefined} isChecked={undefined} value={undefined}            />
            <SettingItem
                icon={<SendOutlinedIcon />}
                title={"Message delivery setting"} subheader={undefined} onChangeCallback={undefined} isChecked={undefined} value={undefined}            />
        </List>
    );
};
